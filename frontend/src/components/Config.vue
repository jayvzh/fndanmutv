  ...
  <div class="plugin-config">
    <v-card class="main-card rounded-lg overflow-hidden">
      ...
      <v-card-text class="pa-6">
        <!-- 插件说明 -->
        <v-alert type="info" variant="tonal" class="mb-5 info-alert">
          ...
          <v-card class="section-card mb-5" elevation="0">
            ...
            <v-card-text class="pa-0 pt-4">
              <v-row>
                ...
                <v-col cols="12" md="6">
                  <div class="setting-item d-flex align-center py-3">
                    <v-icon icon="mdi-file-video-outline" :color="editableConfig.enable_strm ? 'info' : 'grey'" class="mr-3"></v-icon>
                    <div class="setting-content flex-grow-1">
                      <div class="d-flex justify-space-between align-center">
                        <div class="d-flex align-center">
                          <div>
                            <div class="setting-label">启用 STRM 文件刮削</div>
                            <div class="setting-desc text-grey">是否支持 .strm 流媒体文件的弹幕刮削</div>
                          </div>
                          <v-tooltip location="top">
                            ...
                            <div class="tooltip-content">
                              <div class="tooltip-title mb-1">STRM 文件刮削说明</div>
          ...
          <v-card class="section-card mb-5" elevation="0">
            ...
            <v-card-text class="pa-0 pt-4">
              <v-row>
                ...
                <v-col cols="12" md="6">
                  <div class="setting-item d-flex align-center py-3">
                    <v-icon icon="mdi-layers" :color="editableConfig.enable_multi_layer ? 'primary' : 'grey'" class="mr-3"></v-icon>
                    <div class="setting-content flex-grow-1">
                      <div class="d-flex justify-space-between align-center">
                        <div>
                          <div class="setting-label">启用多层弹幕</div>
                          <div class="setting-desc text-grey">开启后弹幕分层显示，具有不同速度和透明度，营造深度感</div>
                        </div>
                        <v-switch
                      ...
                      <div v-if="editableConfig.enable_multi_layer" class="d-flex align-center mt-3">
                        <div class="setting-desc text-grey mr-4">弹幕层数</div>
                        <v-btn-toggle
                          ...
                          :disabled="saving"
                        >
                          <v-btn :value="2">2层</v-btn>
                          <v-btn :value="3">3层</v-btn>
                        </v-btn-toggle>
                        <div class="setting-desc text-grey ml-4">
                ...
                <v-col cols="12" md="6">
                  <div class="setting-item d-flex align-center py-3">
                    <v-icon icon="mdi-format-vertical-align-top" :color="editableConfig.random_top_bottom ? 'primary' : 'grey'" class="mr-3"></v-icon>
                    <div class="setting-content flex-grow-1">
                      <div class="d-flex justify-space-between align-center">
                        <div>
                          <div class="setting-label">随机顶/底部弹幕</div>
                          <div class="setting-desc text-grey">从滚动弹幕中随机分配比例转为悬停弹幕（最大10%）</div>
                        </div>
                        <v-switch
                      ...
                      <div v-if="editableConfig.random_top_bottom" class="d-flex align-center mt-3" style="gap: 12px;">
                        <v-text-field
                ...
                <v-col cols="12" md="6">
                  <div class="setting-item d-flex align-center py-3">
                    <v-icon icon="mdi-chart-bell-curve" color="grey" class="mr-3"></v-icon>
                    <div class="setting-content flex-grow-1">
                      <div class="d-flex justify-space-between align-center">
                        <div>
                ...
                <v-col cols="12" md="6">
                  <div class="setting-item d-flex align-center py-3">
                    <v-icon icon="mdi-arrow-expand-horizontal" color="grey" class="mr-3"></v-icon>
                    <div class="setting-content flex-grow-1">
                      <div class="d-flex justify-space-between align-center">
                        <div>
                          <div class="setting-label">弹幕宽度扩展</div>
                          <div class="setting-desc text-grey">扩大弹幕显示区域宽度，解决超宽屏/手机屏左右空白问题</div>
                        </div>
                        <v-select
